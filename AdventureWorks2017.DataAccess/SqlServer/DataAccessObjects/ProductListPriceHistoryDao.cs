...
{
    public class ProductListPriceHistoryDao : AbstractDao<ProductListPriceHistoryModel>
    {
 ...
 from ProductListPriceHistory";
        ...
        public override string InsertQuery => @"Insert Into ProductListPriceHistory
(
ProductID,
StartDate,
EndDate,
