...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class CustomerDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(connection, new CustomerModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(connection, new CustomerModelPrimaryKey()
            {
                CustomerID = inserted.CustomerID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(connection, new CustomerModelPrimaryKey()
            {
                CustomerID = inserted.CustomerID,
            });
