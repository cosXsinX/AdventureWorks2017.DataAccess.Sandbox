...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class TransactionHistoryArchiveDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new TransactionHistoryArchiveModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new TransactionHistoryArchiveModelPrimaryKey()
            {
                TransactionID = inserted.TransactionID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new TransactionHistoryArchiveModelPrimaryKey()
            {
                TransactionID = inserted.TransactionID,
            });
