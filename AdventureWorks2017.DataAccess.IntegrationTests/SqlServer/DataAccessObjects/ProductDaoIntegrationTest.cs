...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class ProductDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new ProductModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new ProductModelPrimaryKey()
            {
                ProductID = inserted.ProductID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new ProductModelPrimaryKey()
            {
                ProductID = inserted.ProductID,
            });
