...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class CountryRegionDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(connection, new CountryRegionModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(connection, new CountryRegionModelPrimaryKey()
            {
                CountryRegionCode = inserted.CountryRegionCode,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(connection, new CountryRegionModelPrimaryKey()
            {
                CountryRegionCode = inserted.CountryRegionCode,
            });
