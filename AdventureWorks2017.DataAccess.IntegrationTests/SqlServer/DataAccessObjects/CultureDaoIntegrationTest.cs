...
{
    [TestFixture]
    public class CultureDaoIntegrationTests
    {
        private CultureDao _tested;
        ...
        public void IntegrationTest()
        {
            ...
            CultureModel inserted = new CultureModel();
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new CultureModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new CultureModelPrimaryKey()
            {
                CultureID = inserted.CultureID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new CultureModelPrimaryKey()
            {
                CultureID = inserted.CultureID,
            });
