...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class SalesOrderHeaderDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new SalesOrderHeaderModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new SalesOrderHeaderModelPrimaryKey()
            {
                SalesOrderID = inserted.SalesOrderID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new SalesOrderHeaderModelPrimaryKey()
            {
                SalesOrderID = inserted.SalesOrderID,
            });
