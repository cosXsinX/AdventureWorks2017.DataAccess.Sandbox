...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class BusinessEntityContactDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new BusinessEntityContactModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new BusinessEntityContactModelPrimaryKey()
            {
                BusinessEntityID = inserted.BusinessEntityID,
                PersonID = inserted.PersonID,
                ContactTypeID = inserted.ContactTypeID,
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new BusinessEntityContactModelPrimaryKey()
            {
                BusinessEntityID = inserted.BusinessEntityID,
                PersonID = inserted.PersonID,
                ContactTypeID = inserted.ContactTypeID,
