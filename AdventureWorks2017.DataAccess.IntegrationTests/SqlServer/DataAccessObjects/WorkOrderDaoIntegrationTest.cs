...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class WorkOrderDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new WorkOrderModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new WorkOrderModelPrimaryKey()
            {
                WorkOrderID = inserted.WorkOrderID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new WorkOrderModelPrimaryKey()
            {
                WorkOrderID = inserted.WorkOrderID,
            });
