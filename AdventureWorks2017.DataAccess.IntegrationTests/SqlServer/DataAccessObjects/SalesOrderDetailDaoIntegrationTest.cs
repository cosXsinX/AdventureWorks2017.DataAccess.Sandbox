...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class SalesOrderDetailDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new SalesOrderDetailModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new SalesOrderDetailModelPrimaryKey()
            {
                SalesOrderID = inserted.SalesOrderID,
                SalesOrderDetailID = inserted.SalesOrderDetailID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new SalesOrderDetailModelPrimaryKey()
            {
                SalesOrderID = inserted.SalesOrderID,
                SalesOrderDetailID = inserted.SalesOrderDetailID,
            });
