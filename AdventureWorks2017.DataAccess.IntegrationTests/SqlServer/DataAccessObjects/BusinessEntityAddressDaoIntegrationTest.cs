...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class BusinessEntityAddressDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(connection, new BusinessEntityAddressModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(connection, new BusinessEntityAddressModelPrimaryKey()
            {
                BusinessEntityID = inserted.BusinessEntityID,
                AddressID = inserted.AddressID,
                AddressTypeID = inserted.AddressTypeID,
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(connection, new BusinessEntityAddressModelPrimaryKey()
            {
                BusinessEntityID = inserted.BusinessEntityID,
                AddressID = inserted.AddressID,
                AddressTypeID = inserted.AddressTypeID,
