...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class PurchaseOrderDetailDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new PurchaseOrderDetailModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new PurchaseOrderDetailModelPrimaryKey()
            {
                PurchaseOrderID = inserted.PurchaseOrderID,
                PurchaseOrderDetailID = inserted.PurchaseOrderDetailID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new PurchaseOrderDetailModelPrimaryKey()
            {
                PurchaseOrderID = inserted.PurchaseOrderID,
                PurchaseOrderDetailID = inserted.PurchaseOrderDetailID,
            });
