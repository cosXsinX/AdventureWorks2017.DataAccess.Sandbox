...
namespace AdventureWorks2017.DataAccess.IntegrationTests
{
    ...
    public class VendorDaoIntegrationTests
    {
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new VendorModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new VendorModelPrimaryKey()
            {
                BusinessEntityID = inserted.BusinessEntityID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new VendorModelPrimaryKey()
            {
                BusinessEntityID = inserted.BusinessEntityID,
            });
