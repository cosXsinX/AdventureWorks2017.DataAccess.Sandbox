...
{
    [TestFixture]
    public class PhoneNumberTypeDaoIntegrationTests
    {
        private PhoneNumberTypeDao _tested;
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new PhoneNumberTypeModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new PhoneNumberTypeModelPrimaryKey()
            {
                PhoneNumberTypeID = inserted.PhoneNumberTypeID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new PhoneNumberTypeModelPrimaryKey()
            {
                PhoneNumberTypeID = inserted.PhoneNumberTypeID,
            });
