...
{
    [TestFixture]
    public class ProductDescriptionDaoIntegrationTests
    {
        private ProductDescriptionDao _tested;
        public SqlConnection _connection;

        [OneTimeSetUp]
        public void Setup()
        {
            _tested = new ProductDescriptionDao();
        ...
        public void IntegrationTest()
        {
            ...
            var selectedAfterInsertion = _tested.GetByPrimaryKey(_connection, new ProductDescriptionModelPrimaryKey()
            {
            ...
            var selectedAfterUpdateAddresss = _tested.GetByPrimaryKey(_connection, new ProductDescriptionModelPrimaryKey()
            {
                ProductDescriptionID = inserted.ProductDescriptionID,
            });
            ...
            var selectedAfterDeleteAddresss = _tested.GetByPrimaryKey(_connection, new ProductDescriptionModelPrimaryKey()
            {
                ProductDescriptionID = inserted.ProductDescriptionID,
            });
